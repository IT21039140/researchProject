...
function SupportChat() {
  ...
  const handleCareerAreasChange = (e) => {
    const selectedCareers = Array.from(
      e.target.selectedOptions,
      (option) => option.value
    );
        ...
        return (
          <Card className="chat-bubble bot">
            <Card.Body>
              <p>Hello! 👋</p>
              <p>
                Welcome to our personalized university course recommendation
                system.
              </p>
              <p>
                I'm here to help you find the best courses based on your
                interests and goals.
              </p>
              <p>Shall we get started?</p>
              <div className="d-flex justify-content-between">
                <Button onClick={handleNextStep}>
                  Yes, let's start! <FaArrowRight />
                </Button>
              </div>
            </Card.Body>
          </Card>
                  ...
                  <div key={index} className="mb-2">
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          handleSubjectsChange(index, "subject", e.target.value)
                        }
                      />
                    </Form.Group>
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          handleSubjectsChange(index, "result", e.target.value)
                        }
                      />
                    </Form.Group>
                    <Button
            ...
            <Card.Body>
              <Form>
                <Form.Group>
                  ...
                  >
                    <option value="Medicine & Health Care">
                      Medicine & Health Care
                    </option>
      ...
      case 10:
        return (
          <Card className="chat-bubble bot">
            <Card.Body>
              <p>
                Thank you for providing all the information! We are now
                processing your preferences.
              </p>
              <p>
                You will receive your personalized course recommendations
                shortly.
              </p>
            </Card.Body>
          </Card>
